...
export const INITIAL_QUESTIONS: Question[] = [
  ...
  { id: "ts-4", text: "How many CPD hours are typically required for Professional Technologist renewal?", options: ["10 hours", "20 hours", "30 hours", "50 hours"], correctAnswer: 2, category: "General", difficulty: "Medium", target: AssessmentType.PROFESSIONAL_TECHNOLOGIST },
  ...
  { id: "ts-8", text: "What is the primary requirement to upgrade from Graduate Technologist to Professional Technologist?", options: ["Passing a written exam only", "3 years of relevant working experience", "Paying a lifetime fee only", "10 years of experience"], correctAnswer: 1, category: "Act 768", difficulty: "Easy", target: AssessmentType.PROFESSIONAL_TECHNOLOGIST },

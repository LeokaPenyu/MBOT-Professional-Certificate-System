...
export const INITIAL_QUESTIONS: Question[] = [
  ...
  { id: "ts-11", text: "MBOT is a corporate body established under which ministry?", options: ["Ministry of Finance", "Ministry of Science, Technology and Innovation (MOSTI)", "Ministry of Education", "Ministry of Works"], correctAnswer: 1, category: "General", difficulty: "Medium", target: AssessmentType.PROFESSIONAL_TECHNOLOGIST },
  { id: "ts-12", text: "Which of the following describes the 'Graduate Technologist' status?", options: ["A technician with 10 years experience", "A person who holds a recognized Bachelor Degree in Technology", "A person who has passed the professional assessment", "A person with a PhD in any field"], correctAnswer: 1, category: "Act 768", difficulty: "Easy", target: AssessmentType.PROFESSIONAL_TECHNOLOGIST },
  { id: "ts-13", text: "In Industry 4.0, what does 'IoT' stand for?", options: ["Internal of Things", "Internet of Technology", "Internet of Things", "Integration of Technology"], correctAnswer: 2, category: "Industry 4.0", difficulty: "Easy", target: AssessmentType.PROFESSIONAL_TECHNOLOGIST },
  { id: "ts-14", text: "A Technologist who fails to declare a conflict of interest is violating which principle?", options: ["Competence", "Integrity", "Sustainability", "Confidentiality"], correctAnswer: 1, category: "Ethics", difficulty: "Medium", target: AssessmentType.PROFESSIONAL_TECHNOLOGIST },
  { id: "ts-15", text: "Which MBOT field covers the treatment and management of water resources?", options: ["Atmospheric Science", "Green Technology", "Agriculture and Food Technology", "Maritime Technology"], correctAnswer: 1, category: "General", difficulty: "Hard", target: AssessmentType.PROFESSIONAL_TECHNOLOGIST },
  ...
  { id: "tc-11", text: "Which tool is commonly used for measuring small electrical currents?", options: ["Voltmeter", "Ammeter", "Ohmmeter", "Galvanometer"], correctAnswer: 3, category: "General", difficulty: "Easy", target: AssessmentType.CERTIFIED_TECHNICIAN },
  { id: "tc-12", text: "The use of Cloud Computing in manufacturing primarily aims to?", options: ["Store physical goods", "Centralize data and scale resources", "Replace workers", "Reduce internet usage"], correctAnswer: 1, category: "Industry 4.0", difficulty: "Medium", target: AssessmentType.CERTIFIED_TECHNICIAN },
  { id: "tc-13", text: "Lock-Out, Tag-Out (LOTO) procedures are used for?", options: ["Inventory control", "Equipment maintenance safety", "Shift changes", "Office security"], correctAnswer: 1, category: "OSHA", difficulty: "Easy", target: AssessmentType.CERTIFIED_TECHNICIAN }
];

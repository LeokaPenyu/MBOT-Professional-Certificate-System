  ...
  if ([ApplicantStatus.ASSESSMENT_PASSED, ApplicantStatus.CERTIFICATE_READY, ApplicantStatus.CERTIFIED, ApplicantStatus.PROFESSIONAL].includes(user.status)) {
    return (
      <div className="max-w-xl mx-auto py-20 text-center animate-in fade-in zoom-in duration-500">
        ...
        <h1 className="text-3xl font-bold font-display text-slate-900 mb-4 tracking-tight">Test Done</h1>
        <p className="text-slate-500 text-sm font-medium leading-relaxed mb-10">
          Our records show that you have passed the test. You don't need to take it again.
        </p>
        <button 
          onClick={() => navigate('/')}
  ...
  if (!user.feesPaid?.assessment) {
    return (
      <div className="max-w-xl mx-auto py-20 text-center animate-in fade-in zoom-in duration-500">
        ...
        <h1 className="text-3xl font-bold font-display text-slate-900 mb-4 tracking-tight">Locked</h1>
        <p className="text-slate-500 text-sm font-medium leading-relaxed mb-10">
          This test is locked. Please pay the fee to start the test.
        </p>
        <button 
          onClick={() => navigate('/')}
      ...
      <div className="max-w-2xl mx-auto py-12 px-6 animate-in fade-in slide-in-from-bottom-8 duration-700">
        <div className="bg-white rounded-[3rem] p-12 border border-slate-100 shadow-2xl shadow-slate-200/40 relative overflow-hidden">
           ...
           <div className="relative z-10">
                  <div className="w-16 h-16 bg-brand-primary rounded-2xl flex items-center justify-center text-white mb-8 shadow-xl shadow-brand-primary/20">
                 <Shield size={32} />
              </div>
              ...
              <p className="text-slate-500 text-sm font-medium leading-relaxed mb-10 max-w-md">
                You are about to start the required test for MBOT registration. This test checks your knowledge of rules and safety.
              </p>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12 text-left">
                 <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
                    <Clock className="text-brand-primary mb-3" size={20} />
                 ...
                 <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
                    <Award className="text-brand-primary mb-3" size={20} />
              ...
              <div className="flex flex-col gap-6">
                 <button 
                   ...
                   className="w-full py-6 bg-brand-primary text-white rounded-3xl text-sm font-black uppercase tracking-[0.3em] hover:bg-brand-secondary transition shadow-xl shadow-brand-primary/40 active:scale-95"
                 >
                    Start Test
                 </button>
                 <button 
    ...
    return (
      <div className="max-w-xl mx-auto py-20 text-center animate-in fade-in zoom-in duration-500">
        ...
        <h1 className="text-4xl font-bold font-display text-slate-900 mb-2 tracking-tight">
          {passed ? "Test Passed" : "Did Not Pass"}
        </h1>
        ...
        <div className="flex flex-col gap-4">
           {passed && (
             <button 
               className="px-10 py-4 bg-brand-primary text-white font-bold rounded-full hover:bg-brand-secondary transition shadow-lg shadow-brand-primary/40 uppercase tracking-widest text-xs"
               onClick={() => {
                  const updatedUser = { 
                    ...user, 
    ...
    <div className="max-w-4xl mx-auto py-8 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-10">
        ...
        <div className={cn(
          ...
          <Clock size={24} className={timeLeft < 300 ? "text-white" : "text-brand-primary"} /> 
      ...
      <div className="bg-white rounded-[2.5rem] p-12 border border-slate-100 shadow-2xl shadow-slate-200/40 relative overflow-hidden">
        ...
        <div className="space-y-10 relative z-10">
           <div className="flex items-center gap-3">
              <span className="px-4 py-1.5 bg-brand-primary text-white text-[9px] font-black uppercase rounded-full tracking-[0.2em]">
                ...
                <button 
                  ...
                  className={cn(
                    ...
                    answers[currentQuestion.id] === idx 
                      ? "border-brand-primary bg-brand-primary text-white shadow-xl shadow-brand-primary/40 translate-x-2" 
           ...
           <div className="flex justify-between items-center pt-6">
              ...
              {currentIndex === questions.length - 1 ? (
                ...
                <button 
                  onClick={() => setCurrentIndex(prev => prev + 1)}
                  className="px-10 py-4 bg-slate-900 text-white font-bold rounded-full hover:bg-brand-primary flex items-center gap-3 transition-all shadow-xl shadow-slate-900/10 uppercase tracking-widest text-xs"
                >
